...
%%% MULTIIPLE CHOICE QUESTIONS %%%
If the leg is in a non-singular configuration, there is a unique solution for q_dot.
&&
SIGMA = 0 makes the foot point Jacobian rank deficient